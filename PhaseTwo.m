classdef PhaseTwoDesign_exported < matlab.apps.AppBase
    ...
    properties (Access = public)
        ...
        ObliqueSlider        matlab.ui.control.Slider
        ...
        function AxialHorizontalChanging(app,src,evt)
            ...
            switch(evname)
                case{'ROIMoved'}
                    ...
                    app.cvcoordinate=app.chcoordinate;
...
%             try
                ...
                ObliqueSlide=round(app.ObliqueSlider.Value);
                ...
                obliqueLine=drawline('Parent',app.AxialAxes,'Position',[0 0; app.Sagittal app.Coronal],'LineWidth',0.25,'Color','w');
                imshow(rot90(B,-1),[],'Parent' ,app.ObliqueAxes);
...
%             end 
        ...
        % Value changed function: ObliqueSlider
        function ObliqueSliderValueChanged(app, event)
            ObliqueSlide = round(app.ObliqueSlider.Value);
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.DicomViewer.Color = [0.502 0.502 0.502];
            ...
            % Create ObliqueSlider
            app.ObliqueSlider = uislider(app.DicomViewer);
            app.ObliqueSlider.Limits = [0 200];
            app.ObliqueSlider.MajorTicks = [];
            app.ObliqueSlider.Orientation = 'vertical';
            app.ObliqueSlider.ValueChangedFcn = createCallbackFcn(app, @ObliqueSliderValueChanged, true);
            app.ObliqueSlider.Position = [744 70 3 150];
            app.ObliqueSlider.Value = 100;
    ...
    methods (Access = public)
        ...
        % Construct app
        function app = PhaseTwoDesign_exported
